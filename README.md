...
1. Install Argo CD using command below.

```bash
kubectl create ns argocd
curl https://raw.githubusercontent.com/argoproj/argo-cd/v1.3.0-rc1/manifests/install.yaml | sed -e 's/argoproj\/argocd.*/argoproj\/argocd:gitops-poc-3ac6673/g' | kubectl apply -n argocd -f -
```
